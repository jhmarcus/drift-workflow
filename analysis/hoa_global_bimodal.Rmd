...
p_africa + ggsave(paste0("../plots/africa_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_america = structure_plot(gath_df=l_gath_df %>% 
            ...
            ggtitle("America") + 
            theme(plot.title = element_text(size=6))
p_america + ggsave(paste0("../plots/america_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_west_eurasia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("WestEurasia") + 
                 theme(plot.title = element_text(size=6))
p_west_eurasia + ggsave(paste0("../plots/west_eurasia_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_south_asia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("SouthAsia") + 
                 theme(plot.title = element_text(size=6))
p_south_asia + ggsave(paste0("../plots/south_asia_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_east_asia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("EastAsia") + 
                 theme(plot.title = element_text(size=6))
p_east_asia + ggsave(paste0("../plots/east_asia_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_oceania = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("Oceania") + 
                 theme(plot.title = element_text(size=6))
p_oceania + ggsave(paste0("../plots/oceania_", method, "-K", Kmax, filetype), width=8.5, height=2)
...
p_central_asia_siberia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 theme(plot.title = element_text(size=6))
p_central_asia_siberia + ggsave(paste0("../plots/central_asia_siberia_", method, "-K", Kmax, filetype), width=8.5, height=2)
```
