...
However, it seems that, as in the [previous analysis](pm1_priors11.html), some overfitting problems are beginning to rear their heads --- adding the diagonal variance term allows the off-diagonal variance to become very small, and as a result few loadings are estimated to be zero. Compare LFSRs for the first fit and this last one:
