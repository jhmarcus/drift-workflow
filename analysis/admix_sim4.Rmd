...
ggplot(drift.hclust$elbo.df, aes(x = iter, y = elbo)) + geom_line()
...
ggplot(drift.rand$elbo.df, aes(x = iter, y = elbo)) + geom_line()
...
ggplot(drift.perpop$elbo.df, aes(x = iter, y = elbo)) + geom_line()
