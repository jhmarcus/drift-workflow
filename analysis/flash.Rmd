...
```{r functions}
positive_structure_plot = function(gath_df, pops, label_size=5){
...
```{r flash-viz, warning=FALSE, message=FALSE, fig.width=8.5, fig.height=11}
...
p_africa = positive_structure_plot(l_gath_df %>% filter(Region == "Africa"), africa_pops, label_size=5)
...
p_america = positive_structure_plot(l_gath_df %>% filter(Region == "America"), america_pops, label_size=5) 
...
p_central_asia_siberia = positive_structure_plot(l_gath_df %>% filter(Region == "CentralAsiaSiberia"), central_asia_siberia_pops, label_size=5)
...
p_east_asia = positive_structure_plot(l_gath_df %>% filter(Region == "EastAsia"), east_asia_pops, label_size=5)
...
p_south_asia= positive_structure_plot(l_gath_df %>% filter(Region == "SouthAsia"), south_asia_pops, label_size=5)
...
p_west_eurasia = positive_structure_plot(l_gath_df %>% filter(Region == "WestEurasia"), west_eurasia_pops, label_size=5)
...
p_oceania = positive_structure_plot(l_gath_df %>% filter(Region == "Oceania"), oceania_pops, label_size=5) 
...
My impression is that this approach could be promising in building an interpretable visualization of population structure. 
