...
Lets now visualize the fitted `flashier` fit:

```{r flash-viz, warning=FALSE, message=FALSE}
...
My impression is that this approach is promising in building an interpretable visualization of population structure. I will continue to add to this analysis with comparisons to other standard approaches like PCA and the PSD model.