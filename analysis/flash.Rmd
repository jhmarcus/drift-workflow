...
colnames(l_df)[1:(K+1)] = paste0("K=", 1:(K+1)) # name the columns
...
`softImpute`'s solution looks pretty good and picks up similar patterns it seems, though its a bit harder to interpret negative / positive loadings and some of the drift events look denser which also makes interpretation trickier.
