...
Time to try out `drift` on the full admixture graph from [Pickrell and Pritchard](https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1002967). To make the problem easier, I set $p$ large and $\sigma_e$ small.
