...
The mean term should roughly be interpreted as the mean minor allele frequency at the SNP:
...
```{r pca-viz-loadings, warning=FALSE, message=FALSE, fig.width=9, fig.height=7}
