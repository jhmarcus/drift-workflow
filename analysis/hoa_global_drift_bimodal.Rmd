...
fl_drift = readRDS("../output/drift/hoa_global/HumanOriginsPublic2068_auto_maf05_geno005_mind02_K12.rds")
...
p_africa + ggsave("../plots/africa-drift.pdf", width=8.5, height=2)
...
p_america = structure_plot(gath_df=l_gath_df %>% 
            ...
            ggtitle("America") + 
            theme(plot.title = element_text(size=6))
p_america + ggsave("../plots/americas-drift.pdf", width=8.5, height=2)
...
p_west_eurasia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("WestEurasia") + 
                 theme(plot.title = element_text(size=6))
p_west_eurasia + ggsave("../plots/west_eurasia-drift.pdf", width=8.5, height=2)
...
p_south_asia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("SouthAsia") + 
                 theme(plot.title = element_text(size=6))
p_south_asia + ggsave("../plots/south_asia-drift.pdf", width=8.5, height=2)
...
p_east_asia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("EastAsia") + 
                 theme(plot.title = element_text(size=6))
p_east_asia + ggsave("../plots/east_asia-drift.pdf", width=8.5, height=2)
...
p_oceania = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 ggtitle("Oceania") + 
                 theme(plot.title = element_text(size=6))
p_oceania + ggsave("../plots/oceania-drift.pdf", width=8.5, height=2)
...
p_central_asia_siberia = structure_plot(gath_df=l_gath_df %>% 
                 ...
                 theme(plot.title = element_text(size=6))
p_central_asia_siberia + ggsave("../plots/central_asia_siberia-drift.pdf", width=2, height=2)
```
